...
import LeaveManagement from "./LeaveManagement"; // New Module
    ...
    <div className="container-fluid p-0">
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark mb-4 px-3 shadow">
        ...
        <div className="navbar-nav ms-auto">
          ...
          <button 
            className={`btn btn-sm mx-1 ${page === "leave" ? "btn-light" : "btn-outline-light"}`} 
      ...
      <div className="container text-center">
        ...
        {page === "add-review" && (
          <AddReview goBack={() => setPage("task-dashboard")} />
        )}
